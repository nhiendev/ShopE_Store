    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
				...
				<a href="${pageContext.request.contextPath}/index/user" class="btn btn-secondary mb-3"><i class="bi bi-sign-turn-left"></i> Quay lại</a> 
                    <!-- Page Heading -->
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
							...
							<form:form  action="${pageContext.request.contextPath}/index/user/save" modelAttribute="user" method="POST">													  
							    ...
							    <div class="col-sm-10">
							      <form:select class="form-control" path="admin">									
									  ...
									  <form:option value="0">Quản Lý</form:option>
							  			 	...
							  			 	<button  class="btn btn-success  mt-3"><i class="bi bi-save"></i> Update</button>
				                            <button formaction="${pageContext.request.contextPath}/index/user/delete" formmethod="post" class="btn btn-danger mt-3"><i class="bi bi-trash3"></i> Xóa</button>				                         						 								   
							</form:form>
