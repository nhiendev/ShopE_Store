                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody class="align-middle">
                              		 ...
                              		 <form action="${pageContext.request.contextPath }/shop-cart?id=${status.index}" method="Post">
                                        <tr>
                                            <td>
                                                <div class="img">
                                                    <a href="#"><img src="${pageContext.request.contextPath}/img/${brand.imgProduct }" alt="Image"></a>
                                                    <p>${brand.name }</p>
                                                </div>
                                            </td>
                                            <td>${brand.price } $</td>
                    ...
                    <div class="col-lg-4">
                        <div class="cart-page-inner">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                <form action="${pageContext.request.contextPath }/checkout-Cart" method="Post">
                                    <div class="cart-summary">
                                        <div class="cart-content">
                                            <h1>Cart Summary</h1>
                                            <p>Amount<span>${size}</span></p>
